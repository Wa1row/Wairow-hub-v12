...
do -- Example UI
	...
	Tab:AddLabel("By Wairow")

		Tab:AddButton("Fly", function()
			--fly
loadstring(game:HttpGet('https://pastebin.com/raw/YSL3xKYU'))()
		end)
		Tab:AddButton("Vfly", function()
			--vfly
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/CasperFlyModz/discord.gg-rips/main/FPSBooster.lua"))()
		...
		Tab:AddButton("box esp", function()
			--box esp
loadstring(game:HttpGet("https://pastebin.com/raw/zKjj0TQD"))()
	...
	do -- Elements
		Tab:AddLabel("спасибо что используете этот скрипт!")
...
local Tab = Window:AddTab("Hubs in blox fruit")
